...
namespace MyConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            itemService.FindHowManyItemsInItemList(2);
            itemService.FindHowManyItemsInItemList(6);
            itemService.FindHowManyItemsInItemList(3);
            itemService.FindHowManyItemsInItemList(5);
